define('pages/content/media/index.ts', function(require, exports, module) {
  ...
  var categoryType = 0; //0为媒体...1为展会信息
  ...
  var panel = opg_ts_1.default.wrapPanel('#form1', {
      title: "" + lpg.current + lpg.mediaCategory + lpg.search,
  ...
  var tb = opg_ts_1.default('#tb').table({
      ...
      titleBar: {
          title: "" + lpg.mediaUnderCurrentCategory,
          buttons: tbButtons,
      },
      columns: [
          {
  ...
  if (permission.MediaTypeManagment) {
      $('#pButton').show();
      // add category
