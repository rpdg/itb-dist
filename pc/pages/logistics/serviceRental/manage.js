define('pages/logistics/serviceRental/manage.ts', function(require, exports, module) {
  ...
  opg_ts_1.default.api({
      ...
      'getservicelist!post': 'Operation/Getservicelist',
  ...
  refreshtable();
  //view
  var infoPage = '/itb-dist/pc/pages/logistics/serviceRental/view.html?__=1552033897847';
  ...
  function sendApproval(approval, pop) {
      opg_ts_1.default.api.addApproval(approval, function (data) {
          pop.close();
          tb.update();
      });
  }
  //# sourceMappingURL=/itb-dist/pc/pages/logistics/serviceRental/manage.js.map?__=1552033897847
