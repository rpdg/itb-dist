define('pages/logistics/cateringRental/cateringlist.ts', function(require, exports, module) {
  ...
  opg_ts_1.default.api({
      'getAllcatering!post': 'Operation/Getallcatering',
  });
  ...
  opg_ts_1.default.api.getAllcatering(param, function (data) {
  ...
  window['getCateringFill'] = function () {
      param.itemno = "";
      param.itemqty = "";
      var len = $("#listtable tr").length;
      for (var i = 1; i < len; i++) {
  ...
  //# sourceMappingURL=/itb-dist/pc/pages/logistics/cateringRental/cateringlist.js.map?__=1552033897847
