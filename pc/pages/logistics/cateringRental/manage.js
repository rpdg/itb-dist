define('pages/logistics/cateringRental/manage.ts', function(require, exports, module) {
  ...
  var tb = opg_ts_1.default('#tb').table({
      api: opg_ts_1.default.api.getcateringlist,
      lazy: true,
      titleBar: {
          title: "" + lpg.list,
          buttons: tbButtons,
  ...
  refreshtable();
  //view
  var infoPage = '/itb-dist/pc/pages/logistics/cateringRental/view.html?__=1552033897847';
  ...
  //# sourceMappingURL=/itb-dist/pc/pages/logistics/cateringRental/manage.js.map?__=1552033897847
