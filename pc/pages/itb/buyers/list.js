define('pages/itb/buyers/list.ts', function(require, exports, module) {
  ...
  function makeRegion(arr) {
      ...
      if (Languages_1.Languages.current === 'en') {
          ...
          data = utils_2.array.sort(arr, fieldName_1, function (a, b) {
          ...
          data = utils_2.array.sort(arr, fieldName_2, function (a, b) {
  ...
  //# sourceMappingURL=/itb-dist/pc/pages/itb/buyers/list.js.map?__=1552033897847
