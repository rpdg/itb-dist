define('pages/exhibitionInfo/list.ts', function(require, exports, module) {
  ...
  api_1.api({
      getList: "mediaexhibtion/QueryAllEnableMediaExhibtionInfos?type=1&mediaExhitionInfoTypeId=" + typeId + "&pageSize=" + pageSize
  });
  /**
   * 下拉刷新具体业务实现
   */
  ...
  //# sourceMappingURL=/itb-dist/wap/pages/exhibitionInfo/list.js.map?__=1552030651276
